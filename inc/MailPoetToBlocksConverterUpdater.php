 ...
 */
class MailPoetToBlocksConverterUpdater {
	...
	public function __construct($version, $pluginSlug, $pluginFile) {
		...
		$this->cacheKey = 'mailpoet-to-blocks-update-check';
	...
	public function request(){
		...
		if( false === $remote || ! $this->cacheAllowed ) {
			...
			$remote = wp_remote_get(
				'https://pluginmachine.app/api/plugins/info/116842b4-459d-4d97-a6a5-6bdb3e662f8e',
				[
					'timeout' => 10,
					'headers' => array(
